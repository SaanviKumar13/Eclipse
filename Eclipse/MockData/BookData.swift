...
var mockBooks: [Book] = [
    Book(
        ...
        rentersNearby: 5,
        seriesInfo: nil,
        status: .wantToRead, isCollectorsEdition: true
    ),
    ...
    Book(
        ...
        rentersNearby: 3,
        seriesInfo: nil,
        status: .finished ,isCollectorsEdition: true
    ),
    ...
    Book(
        ...
        status: .currentlyReading, isCollectorsEdition: true
    ),
    ...
    Book(
        ...
        rentersNearby: 6,
        seriesInfo: nil,
        status: .wantToRead, isCollectorsEdition: false
    ),
    ...
    Book(
        ...
        rentersNearby: 8,
        seriesInfo: nil,
        status: .finished, isCollectorsEdition: false
    ),
    ...
    Book(
        ...
        rentersNearby: 5,
        seriesInfo: nil,
        status: .didNotFinish, isCollectorsEdition: false
    ),
    ...
    Book(
        ...
        rentersNearby: 4,
        seriesInfo: nil,
        status: .currentlyReading, isCollectorsEdition: false
    ),
