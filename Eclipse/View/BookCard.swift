...
//        label.backgroundColor = UIColor(named: "#ECECEC")
...
//        label.font = .systemFont(ofSize: 14)
//        label.textAlignment = .center
//        label.backgroundColor = UIColor(named: "#005C78")
...
//        button.tintColor = UIColor(named: "#005C78")
...
//        button.setTitleColor(UIColor(named: "#005C78"), for: .normal)
//        button.translatesAutoresizingMaskIntoConstraints = false
//        return button
//    }()
//
