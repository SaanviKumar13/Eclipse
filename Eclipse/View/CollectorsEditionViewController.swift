...
//
//    // Sample data
//    private let collectorsEditionBooks = ["devotion", "flawed", "dune", "verity"]
//    private let regularBooks = ["verity", "flawed", "verity", "dune", "devotion", "flawed"]
//
...
//        NSLayoutConstraint.activate([
//            ratingLabel.leadingAnchor.constraint(equalTo: distanceLabel.trailingAnchor, constant: 16),
//            ratingLabel.centerYAnchor.constraint(equalTo: distanceLabel.centerYAnchor)
//        ])
//
