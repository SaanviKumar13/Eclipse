...
class OnboardingViewController: UIViewController {
    ...
    private func setupUI() {
        ...
        continueButton.addTarget(self, action: #selector(navigateToPreferences), for: .touchUpInside)
    ...
    @objc private func navigateToPreferences() {
        let nextViewController = CreateAccountViewController()
